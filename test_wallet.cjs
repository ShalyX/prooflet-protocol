...
const c = initiateDeveloperControlledWalletsClient({ apiKey: "TEST_API_KEY:fecd523961f0a7e3328e075a666f0cbf:9b60cdd24affe817c1394ddce51f6dc9", entitySecret: "412bdfa40d71f3286c291060d52b39dbba5a1f435dcefbe6f0c9024a21c3bfb0" });
...
async function main() {
  ...
  if (w) console.log("OK:", w.id, w.address, w.blockchain);
  else console.log("NONE:", JSON.stringify(r.data).slice(0,300));
}
