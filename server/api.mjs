...
function serializeAgent(row) {
  return { agentId: row.agent_id, name: row.name, capabilities: parseJson(row.capabilities_json, []), payoutAddress: row.payout_address, status: row.status, reputationScore: row.reputation_score };
}
